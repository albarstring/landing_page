...
const Hero = () => {
  ...
  const Container = ({ children, className = "" }) => (
    <div className={`py-4 px-2 mx-auto max-w-screen-xl sm:py-4 lg:px-6 ${className}`}>{children}</div>
  );
  ...
  return (
    <>
      ...
      <section className="mt-[-3rem]">
        <Container className="max-w-3xl px-5 mt-4">
      ...
      >
        <div className="max-w-6xl mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          <div className="md:ml-[-24px]"> {/* Tambah margin kiri di desktop */}
      ...
      <section
        className="flex justify-center items-center my-12 py-24"
        aria-label="Let your content speak"
      >
        <div
          className="relative w-full max-w-6xl rounded-2xl flex items-center px-6 py-10 md:py-12 mx-auto"
          style={{
            background: "#B71C1C",
            minHeight: "180px",
            overflow: "visible",
        ...
        >
          {/* Left: Hand with bag */}
          <img
            src="/images/brandio-bag-hand.png"
            alt="Brandio Bag Hand"
            className="absolute left-0 bottom-0 h-28 md:h-32 z-10"
            style={{
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center mx-auto z-20">
            <h2
              className="text-white text-xl md:text-4xl font-bold mb-6"
              style={{
                fontFamily: "'Montserrat', 'Inter', Arial, sans-serif",
                letterSpacing: "0.01em",
                lineHeight: 1.2,
            ...
            >
              Let your content speak<br className="hidden md:block" />
              and know who hears it.
            </h2>
            <a
              href="#kontak"
              className="inline-block px-8 py-3 rounded-full font-semibold text-white bg-[#CC262A] hover:bg-[#a61b1f] transition-colors duration-200 shadow-md text-base"
              style={{
                minWidth: 120,
          ...
          <div className="absolute right-0 -top-32 flex flex-col items-end z-20">
            <div className="relative">
              <img
                src="/images/people1.png"
                alt="Woman with megaphone"
                className="h-64 md:h-[420px] lg:h-[520px]"
                style={{
                  objectFit: "contain",
                  marginRight: "-3.5rem",
                  marginTop: "-5rem",
              ...
              {/* Badge */}
              <span
                className="absolute top-0 right-14 bg-[#CC262A] text-white text-base font-bold px-4 py-2 rounded-full shadow-lg"
                style={{
                  fontFamily: "'Montserrat', 'Inter', Arial, sans-serif",
                  letterSpacing: "0.01em",
                  zIndex: 30,
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch gap-10">
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center md:justify-start md:pr-8 mb-8 md:mb-0">
              ...
              <p
                ...
                data-aos-delay="200"
              >
                Strategic locations in Serang City and surrounding areas, ready to maximize your promotional reach.
              </p>
      ...
      <section
        id="kontak"
        className="py-10 text-[#2B3146] relative rounded-3xl" // py-20 -> py-10
        style={{
          borderRadius: "0 0 3rem 3rem / 0 0 2rem 2rem",
        }}
        data-aos="fade-in"
      >
        <Container className="max-w-3xl px-4 text-center">
          <div className="bg-[#CC262A] rounded-3xl shadow-lg p-2 md:p-4 relative overflow-hidden"> {/* md:p-6 -> md:p-4 */}
            {/* Decorative Boxicons - Banyak */}
            <i
              className="bx bx-bullseye absolute top-4 left-4 text-white" // top-6 left-6 -> top-4 left-4
              style={{
                fontSize: 48, // 64 -> 48
                opacity: 0.5,
                zIndex: 1,
            ...
            ></i>
            <i
              className="bx bx-megaphone absolute bottom-4 right-4 text-white" // bottom-8 right-8 -> bottom-4 right-4
              style={{
                fontSize: 56, // 80 -> 56
                opacity: 0.5,
                zIndex: 1,
            ...
            ></i>
            <i
              className="bx bx-bar-chart-alt-2 absolute bottom-2 left-1/2 -translate-x-1/2 text-white" // bottom-4 -> bottom-2
              style={{
                fontSize: 60, // 90 -> 60
                opacity: 0.4,
                zIndex: 1,
            ...
            ></i>
            <i
              className="bx bx-bulb absolute top-6 right-6 text-white" // top-10 right-10 -> top-6 right-6
              style={{
                fontSize: 32, // 48 -> 32
                opacity: 0.45,
                zIndex: 1,
            ...
            ></i>
            <i
              className="bx bx-rocket absolute bottom-6 left-6 text-white" // bottom-10 left-10 -> bottom-6 left-6
              style={{
                fontSize: 36, // 54 -> 36
                opacity: 0.5,
                zIndex: 1,
            ...
            ></i>
            <i
              className="bx bx-star absolute top-[20%] right-[20%] text-white" // top-1/4 right-1/4 -> top-[20%] right-[20%]
              style={{
                fontSize: 28, // 40 -> 28
                opacity: 0.4,
                zIndex: 1,
            ...
            ></i>
            <i
              className="bx bx-volume-full absolute bottom-[20%] left-[20%] text-white" // bottom-1/4 left-1/4 -> bottom-[20%] left-[20%]
              style={{
                fontSize: 30, // 44 -> 30
                opacity: 0.45,
                zIndex: 1,
            ...
            ></i>
            <i
              className="bx bx-message-dots absolute top-[33%] right-4 text-white" // top-1/3 right-8 -> top-[33%] right-4
              style={{
                fontSize: 26, // 38 -> 26
                opacity: 0.4,
                zIndex: 1,
            ...
            ></i>
            <i
              className="bx bx-like absolute bottom-[33%] left-4 text-white" // bottom-1/3 left-8 -> bottom-[33%] left-4
              style={{
                fontSize: 26, // 38 -> 26
                opacity: 0.4,
                zIndex: 1,
            ...
            ></i>
            <i
              className="bx bx-network-chart absolute bottom-1 right-1/2 translate-x-1/2 text-white" // bottom-2 -> bottom-1
              style={{
                fontSize: 40, // 60 -> 40
                opacity: 0.35,
                zIndex: 1,
            ...
            <h2
              className="text-2xl md:text-3xl font-bold mb-2 text-white relative z-10" // text-3xl md:text-4xl mb-4 -> text-2xl md:text-3xl mb-2
              style={{
                fontFamily: "'Montserrat', 'Inter', Arial, sans-serif",
                letterSpacing: "0.01em",
              }}
            ...
            <p
              className="mb-4 text-base text-white w-90 mx-auto text-center relative z-10" // mb-8 text-lg -> mb-4 text-base
              data-aos="fade-up"
              data-aos-delay="200"
            >
              Hubungi kami untuk konsultasi gratis dan dapatkan penawaran terbaik
              <br />untuk kebutuhan iklan Anda di Kota Serang!
            </p>
            {/* Lottie animation above WhatsApp button */}
            <div className="flex justify-center mb-4 relative z-10"> {/* mb-6 -> mb-4 */}
              <div className="bg-[#e9f9f1] rounded-full p-1 flex items-center justify-center relative overflow-visible"> {/* p-2 -> p-1 */}
                {/* Decorative icon for green rounded, positioned to fit with content */}
                <i
                  className="bx bx-chat absolute -top-2 -left-2 text-[#25D366]" // -top-4 -left-4 -> -top-2 -left-2
                  style={{
                    fontSize: 24, // 36 -> 24
                    opacity: 0.5,
                    zIndex: 2,
                ...
                ></i>
                <i
                  className="bx bx-send absolute -bottom-2 -right-2 text-[#25D366]" // -bottom-4 -right-4 -> -bottom-2 -right-2
                  style={{
                    fontSize: 20, // 32 -> 20
                    opacity: 0.5,
                    zIndex: 2,
                ...
                <DotLottieReact
                  ...
                  loop
                  autoplay
                  style={{ width: 60, height: 60 }} // width: 120, height: 120 -> 60
                />
              </div>
            </div>
            <a
              ...
              className="inline-block px-6 py-1.5 bg-[#25D366] text-white font-semibold rounded-full shadow-xl hover:bg-[#1ebe5d] transition text-base items-center text-center justify-center gap-2 relative z-10" // px-10 py-2 text-lg -> px-6 py-1.5 text-base
              style={{ boxShadow: "0 8px 32px 0 rgba(60, 80, 120, 0.10)" }}
              data-aos="zoom-in"
              data-aos-delay="300"
            >
                <i className="bx bxl-whatsapp text-xl"></i> {/* text-2xl -> text-xl */}
      ...
      <section className="py-24">
        <Container className="flex flex-col md:flex-row gap-12 px-8">
          <div className="flex flex-col text-left basis-1/2">
            <p className="inline-block font-semibold text-[#CC262A] mb-4">FAQ</p>
            <p className="sm:text-4xl text-2xl font-medium text-[#2B3146]">Everything You Need to Know <br /> About Brandio</p>
          </div>
          <ul className="basis-1/2">
            {[
              ...
              <li key={idx} className="mb-4">
                <div
                  className="w-full border-t md:text-lg border-[#CC262A]/10 rounded-xl bg-white shadow-lg transition-all hover:rounded-xl hover:shadow-2xl"
                  style={{ marginBottom: "0.5rem", boxShadow: "0 4px 24px 0 rgba(44, 62, 80, 0.10)" }}
                >
                  <button
                    type="button"
                    className="relative flex gap-2 items-center w-full py-5 text-base font-semibold text-left rounded-xl focus:outline-none"
                    aria-expanded="false"
                  ...
                  >
                    ...
                    <svg
                      ...
                      aria-hidden="true"
                    >
                      <path d="M6 8l4 4 4-4" stroke="#2B3146" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </button>
                  <div
                    className="transition-all duration-300 ease-in-out max-h-0 overflow-hidden px-6"
                    style={{ transition: "max-height 0.3s ease-in-out 0s" }}
                  >
                    <div className="pb-5 leading-relaxed">
                      <div className="space-y-2 leading-relaxed text-[#4B5563]">{item.answer}</div>
                    </div>
                  </div>
                </div>
              </li>
